...
public class LeavesVibratingCategory extends CreateRecipeCategory<LeavesVibratingRecipe> {
	...
	public void draw(LeavesVibratingRecipe recipe, IRecipeSlotsView iRecipeSlotsView, PoseStack matrixStack, double mouseX, double mouseY) {
		...
		Minecraft.getInstance().font.draw(matrixStack, Component.translatable(VintageImprovements.MODID + ".jei.text.leaves_vibrating.text1"), 87, 3, 0xFAFAFA);
		Minecraft.getInstance().font.draw(matrixStack, Component.translatable(VintageImprovements.MODID + ".jei.text.leaves_vibrating.text2"), 87, 14, 0xFAFAFA);
		Minecraft.getInstance().font.draw(matrixStack, Component.translatable(VintageImprovements.MODID + ".jei.text.leaves_vibrating.text3"), 87, 25, 0xFAFAFA);
		Minecraft.getInstance().font.draw(matrixStack, Component.translatable(VintageImprovements.MODID + ".jei.text.leaves_vibrating.text4"), 87, 36, 0xFAFAFA);
		Minecraft.getInstance().font.draw(matrixStack, Component.translatable(VintageImprovements.MODID + ".jei.text.leaves_vibrating.text5"), 87, 47, 0xFAFAFA);
		Minecraft.getInstance().font.draw(matrixStack, Component.translatable(VintageImprovements.MODID + ".jei.text.leaves_vibrating.text6"), 87, 58, 0xFAFAFA);
	}
